export {handle as afHandleWorkshopAdd} from './add-permission-af.handler';
export {handle as cmHandleWorkshopAdd} from './add-permission-cm.handler';
...
export {handle as addFacAffPerm} from './add-fac-aff.handler';
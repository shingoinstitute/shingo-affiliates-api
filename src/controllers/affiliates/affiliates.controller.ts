...
export class AffiliatesController extends BaseController {
  ...
  public async readAll(
    ...
    if (
      !isPublic &&
      (!session.user || session.user.role.name !== 'Affiliate Manager')
    )
      return this.handleError(
        res,
        'Error in AffiliatesController.readAll(): ',
        { error: 'NOT_AFFILIATE_MANAGER' },
  ...
  public async describe(
    ...
    try {
      ...
      return this.handleError(
        res,
        'Error in AffiliatesController.describe(): ',
        error
      )
    }
  }
  ...
  public async search(
    ...
    if (!search || !retrieve)
      return this.handleError(
        res,
        'Error in AffiliatesController.search(): ',
        {
    ...
    try {
      const affiliates = await this.affService.search(
        search,
        retrieve,
        refresh === 'true'
      )
  ...
  public async searchCMS(
    ...
    if (!id.match(/[\w\d]{15,17}/))
      return this.handleError(
        res,
        'Error in AffiliatesController.searchCMS(): ',
        {
          error: 'INVALID_SF_ID',
    ...
    try {
      const cms = await this.affService.searchCM(
        id,
        search,
        retrieve,
        refresh === 'true'
  ...
  public async read(@Response() res: Res, @Param('id') id: string) {
    if (!id.match(/[\w\d]{15,17}/))
      return this.handleError(
        res,
        'Error in AffiliatesController.read(): ',
        {
          error: 'INVALID_SF_ID',
          message: `${id} is not a valid Salesforce ID.`,
        },
  ...
  public async create(@Response() res: Res, @Body() body: any) {
    ...
    if (!required.valid)
      return this.handleError(
        res,
        'Error in AffiliatesController.create(): ',
  ...
  public async map(
    ...
    if (
      !id.match(/[\w\d]{15,18}/) ||
      !affiliate.Id.match(/[\w\d]{15,18}/) ||
      id !== affiliate.Id
    )
      return this.handleError(
        res,
        'Error in AffiliatesController.map(): ',
        {
          error: 'INVALID_SF_ID',
          message: `${id} is not a valid Salesforce ID.`,
        },
  ...
  public async update(
    ...
    if (!id.match(/[\w\d]{15,17}/) || id !== body.Id)
      return this.handleError(
        res,
        'Error in AffiliatesController.update(): ',
        {
          error: 'INVALID_SF_ID',
          message: `${id} is not a valid Salesforce ID.`,
        },
  ...
  public async delete(@Response() res: Res, @Param('id') id: string) {
    if (!id.match(/[\w\d]{15,17}/))
      return this.handleError(
        res,
        'Error in AffiliatesController.delete(): ',
        {
          error: 'INVALID_SF_ID',
          message: `${id} is not a valid Salesforce ID.`,
        },
